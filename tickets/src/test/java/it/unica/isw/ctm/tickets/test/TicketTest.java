...
public class TicketTest {
	...
	public boolean testEquals() throws Exception {
		...
		Ticket90minutes tick90min0 = new Ticket90minutes(VENDORS.CTM, id0);
		Ticket90minutes tick120min0 = new Ticket90minutes(VENDORS.ARST, id1);
		...
		Ticket120minutes tick120min1 = new Ticket120minutes(VENDORS.ARST, id0);
